...
@section('content')
    ...
    <table class="Rtable Rtable--7cols">
        <tr>
            ...
            <th class="Rtable-cell">Restore</th>
        ...
        @foreach($user as $item)
            <tr>
                ...
                <td class="center">
                    <form action="{{url("admin/user/restore/$item->id")}}" method="get">
                        <input type="submit" class="btn btn-primary" value="Restore" onclick="alert('Restored user')">
                    </form>
                </td>
                <td class="center">
